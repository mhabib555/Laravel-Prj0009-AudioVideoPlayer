                ...
                <div id="blue-playlist-container">
                    ...
                    <div id="amplitude-player">
                        ...
                        <div id="amplitude-left">
                            <img data-amplitude-song-info="cover_art_url" id="album-art" />
                            <div class="amplitude-visualization" id="large-visualization"></div>
                            <div id="player-left-bottom">
                                <div id="time-container">
                                    <span class="current-time"> <span class="amplitude-current-minutes"></span>:<span class="amplitude-current-seconds"></span> </span>
        ...
        mounted() {
            ...
            */
            Amplitude.init({
                "songs": [
                    {
                        "name": "Sameh_melody4arab.com",
                        "artist": "Maher Zain",
                        "album": "Collection",
                        "genre": "Arabic",
                        "url": "/api/gettrack/Sameh_melody4arab.com.mp3",
  ...
  div#amplitude-right {
    ...
    div#amplitude-right div.song {
      ...
      div#amplitude-right div.song div.play-button-container {
        display: none;
        background: url("/player/blue-player/list-play-light.png") no-repeat;
        width: 22px;
        height: 22px;
        margin-top: 10px; }
      div#amplitude-right div.song div.play-button-container:hover {
        background: url("/player/blue-player/list-play-hover.png") no-repeat; }
    ...
    div#control-container div#repeat-container {
      ...
      div#control-container div#repeat-container div#repeat {
        ...
        div#control-container div#repeat-container div#repeat.amplitude-repeat-off {
          background: url("/player/blue-player/repeat-off.svg"); }
        div#control-container div#repeat-container div#repeat.amplitude-repeat-on {
          background: url("/player/blue-player/repeat-on.svg"); }
      div#control-container div#repeat-container div#shuffle {
        ...
        div#control-container div#repeat-container div#shuffle.amplitude-shuffle-off {
          background: url("/player/blue-player/shuffle-off.svg"); }
        div#control-container div#repeat-container div#shuffle.amplitude-shuffle-on {
          background: url("/player/blue-player/shuffle-on.svg"); }
    @media all and (-ms-high-contrast: none) {
    ...
    div#control-container div#central-control-container {
      ...
      div#control-container div#central-control-container div#central-controls {
        ...
        div#control-container div#central-control-container div#central-controls div#previous {
          ...
          height: 40px;
          cursor: pointer;
          background: url("/player/blue-player/prev.svg");
        ...
        div#control-container div#central-control-container div#central-controls div#play-pause {
          ...
          div#control-container div#central-control-container div#central-controls div#play-pause.amplitude-paused {
            background: url("/player/blue-player/play.svg"); }
          div#control-container div#central-control-container div#central-controls div#play-pause.amplitude-playing {
            background: url("/player/blue-player/pause.svg"); }
        div#control-container div#central-control-container div#central-controls div#next {
          display: inline-block;
          width: 40px;
          height: 40px;
          cursor: pointer;
          background: url("/player/blue-player/next.svg");
          background-repeat: no-repeat;
          float: left;
          margin-top: 10px;
          margin-left: -5px; }
